...
The Elf explains that you've arrived at Snow Island and apologizes for the lack of 
    snow. He'll be happy to explain the situation, but it's a bit of a walk, so you
    have some time. They don't get many visitors up here; would you like to play a
...
In the example above, games 1, 2, and 5 would have been possible if the bag had been 
    ...
    have been impossible because the Elf showed you 15 blue cubes at once. If you add
